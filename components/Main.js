  ...
  return (
    ...
    <div id="home" className='w-full h-screen text-center'>
      <div className='max-w-[1240px] w-full h-full mx-auto p-3 flex justify-center items-center'>
        <div>
            <p className='pt-10 text-sm font-bold tracking-widest text-gray-600 uppercase'>LET'S BUILD SOMETHING TOGETHER</p>
            ...
            <p className='py-4 text-gray-600 max-w-[70%] m-auto'>
                I'm a front End React Js Web Developer spacializing in building (and occasionally designing) exceptional digital experience.
